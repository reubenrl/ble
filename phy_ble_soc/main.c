...
void ble_uhf_client_main(void);	/* added */
void ble_sensor_server_main(void);	/* added */
...
void main(void)
{
  ...
  /* select SPP client or server role based on PB0/PB1 status.
   ...
   {	/* added */
 	  printf("* ble_uhf client mode *\r\n");
 	  ble_uhf_client_main();
   }
   else
   {
 	  printf("* ble_sensor server mode *\r\n");
 	  ble_sensor_server_main();
   }
